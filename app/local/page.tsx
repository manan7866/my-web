...
import { storage, FirebaseProvider } from "@/app/components/firebase"; // درست راستہ
...
export default function Home() {
  ...
  return (
    <FirebaseProvider >
    <div style={{ background: "linear-gradient(#007cc4 ,#1c0794)" }} className="flex flex-col items-center  w-full">
      <form onSubmit={handleSubmit} className="w-[700px] m-20 rounded-[15px] bg-[rgba(255,255,255,0.7)]">
        ...
        {pdflink && (
          <a className="  text-blue-400" href={pdflink} target="_blank" rel="noopener noreferrer">{pdflink}</a>
        )}
